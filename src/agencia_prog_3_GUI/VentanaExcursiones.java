...
//        }
//        
//        //Hacer panel de personas + filtro de busqueda
//        public JPanel configurarBusquedaExcursion() {
...
//            campoPersonas = new JTextField("1", 4);
...
//            if (txt.isEmpty()) ordena.setRowFilter(null);
//            else ordena.setRowFilter(RowFilter.regexFilter("(?i)" + Pattern.quote(txt), 1)); // columna Título
//        }
//        
//        
...
//        
//        ///Crear clase aparte ///
//        public static class ExcursionTabla extends AbstractTableModel {
//            private final String[] columnas = {"ID", "Título", "Descripción", "Precio", "Reservar"};
//            private final List<Excursion> data
//            ;
//            public ExcursionTabla(List<Excursion> d) { 
//            	this.data = d; 
//            	
//            }
//            @Override 
...
//                };
//            }
//            public Excursion getAt(int r) { return data.get(r); }
//        }
//        
//        
//      ///Crear clase aparte ///
