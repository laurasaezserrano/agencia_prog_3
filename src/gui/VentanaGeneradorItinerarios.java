...
/**
 * Clase para generar itinerarios utilizando recursividad
 */
class GeneradorItinerariosRecursivos {
...
/**
 * Clase para generar rutas conectadas utilizando recursividad
 */
class GenerarRutasConectadas {
    ...
    private static void generarRutasRecursivo(List<DatosVuelos> vuelos,
        ...
        for (DatosVuelos vuelo : vuelos) {
            if (vuelo.getOrigen().toString().equals(ciudadOrigen)) {
